...
public final class Foo {
  ...
  public interface PersonOrBuilder
    ...
    boolean hasGender();
    lion.bean.Foo.Person.Gender getGender();
  }
  public static final class Person extends
    ...
    private lion.bean.Foo.Person.Gender gender_;
    public boolean hasGender() {
      return ((bitField0_ & 0x00000008) == 0x00000008);
    }
    public lion.bean.Foo.Person.Gender getGender() {
      return gender_;
    }
    ...
    private void initFields() {
      ...
      gender_ = lion.bean.Foo.Person.Gender.MALE;
    }
    ...
    public static lion.bean.Foo.Person parseFrom(
    ...
    public static lion.bean.Foo.Person parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static lion.bean.Foo.Person parseFrom(
    ...
    public static lion.bean.Foo.Person parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static lion.bean.Foo.Person parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static lion.bean.Foo.Person parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder(lion.bean.Foo.Person prototype) {
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageLite.Builder<
          lion.bean.Foo.Person, Builder>
        implements lion.bean.Foo.PersonOrBuilder {
      ...
      public lion.bean.Foo.Person getDefaultInstanceForType() {
        return lion.bean.Foo.Person.getDefaultInstance();
      }
      
      public lion.bean.Foo.Person build() {
        lion.bean.Foo.Person result = buildPartial();
      ...
      private lion.bean.Foo.Person buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        lion.bean.Foo.Person result = buildPartial();
        if (!result.isInitialized()) {
      ...
      public lion.bean.Foo.Person buildPartial() {
        lion.bean.Foo.Person result = new lion.bean.Foo.Person(this);
      ...
      public Builder mergeFrom(lion.bean.Foo.Person other) {
        if (other == lion.bean.Foo.Person.getDefaultInstance()) return this;
        if (other.hasId()) {
          setId(other.getId());
        }
        if (other.hasName()) {
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 32: {
              ...
              lion.bean.Foo.Person.Gender value = lion.bean.Foo.Person.Gender.valueOf(rawValue);
              if (value != null) {
  ...
  bitField0_ |= 0x00000004;
      ...
      // optional .foo.Person.Gender gender = 4;
      private lion.bean.Foo.Person.Gender gender_ = lion.bean.Foo.Person.Gender.MALE;
      public boolean hasGender() {
        return ((bitField0_ & 0x00000008) == 0x00000008);
      }
      public lion.bean.Foo.Person.Gender getGender() {
      ...
      public Builder setGender(lion.bean.Foo.Person.Gender value) {
        if (value == null) {
          throw new NullPointerException();
        }
        bitField0_ |= 0x00000008;
