...
import j.se.jmx.mbean.hello.HelloFilter;
import j.se.jmx.mbean.hello.HelloListener;
...
public class CopyOfHelloAgent {
	...
	public static void main(String[] args) throws Exception {
		...
		// 加入MBeanServer
		server.addNotificationListener(helloName, listener, filter, null);
