...
public class AlarmSettingsDAOImpl implements AlarmSettingsDAO {
	...
	public boolean updateAlarmSettingsByClusterId(AlarmSettings alarmSettings) throws DaoException {
		...
		//从数据库中获取指定zookeeper集群中所有机器
		try {
			String updateSql = StringUtil.replaceSequenced(SQL_UPDATE_ALARM_SETTINGS_BY_ID, alarmSettings.getMaxDelayOfCheck(), alarmSettings.getMaxCpuUsage(), alarmSettings.getMaxMemoryUsage(), alarmSettings.getMaxLoad(),
					alarmSettings.getWangwangList(), alarmSettings.getPhoneList(), alarmSettings.getEmailList(), alarmSettings.getMaxConnectionPerIp(), alarmSettings.getMaxWatchPerIp(), alarmSettings.getDataDir(), alarmSettings.getDataLogDir(),
					alarmSettings.getMaxDiskUsage(), alarmSettings.getClusterId() + EMPTY_STRING);
	...
	public boolean addAlarmSettings(AlarmSettings alarmSettings) throws DaoException {
		...
		try {
			String insertSql = StringUtil.replaceSequenced(SQL_ADD_ALARM_SETTINGS, alarmSettings.getClusterId() + EMPTY_STRING, alarmSettings.getMaxDelayOfCheck(), alarmSettings.getMaxCpuUsage(), alarmSettings.getMaxMemoryUsage(),
					alarmSettings.getMaxLoad(), alarmSettings.getWangwangList(), alarmSettings.getPhoneList(), alarmSettings.getEmailList(), alarmSettings.getMaxConnectionPerIp(), alarmSettings.getMaxWatchPerIp(), alarmSettings.getDataDir(),
					alarmSettings.getDataLogDir(), alarmSettings.getMaxDiskUsage());
