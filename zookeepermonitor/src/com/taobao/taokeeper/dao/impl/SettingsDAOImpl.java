...
public class SettingsDAOImpl implements SettingsDAO {
	...
	public boolean updateTaoKeeperSettingsBySettingsId(TaoKeeperSettings taoKeeperSettings) throws DaoException {
		...
		try {
			String updateSql = StringUtil.replaceSequenced(SQL_UPDATE_TAOKEEPER_SETTINGS_BY_ID, taoKeeperSettings.getEnvName(), taoKeeperSettings.getMaxThreadsOfZooKeeperCheck() + EMPTY_STRING, taoKeeperSettings.getDescription(),
					taoKeeperSettings.getSettingsId() + EMPTY_STRING);
