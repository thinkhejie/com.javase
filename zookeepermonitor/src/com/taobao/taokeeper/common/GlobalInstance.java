...
public class GlobalInstance {
	...
	private static Map<String/** IP */
	, HostPerformanceEntity> hostPerformanceEntitySet = new ConcurrentHashMap<String, HostPerformanceEntity>();
	// ZooKeeper集群中每台机器状态信息-更新时间
	...
	, Map<String, Connection>> zooKeeperClientConnectionMapOfCluster = new ConcurrentHashMap<Integer/**clusterId */
	, Map<String, Connection>>();

	/** zookeeper 每个Server上的客户端连接情况 */
	public static Map<String/** clusterId-serverIp */
	, Map<String, Connection>> zooKeeperClientConnectionMapOfServer = new ConcurrentHashMap<String/**clusterId */
	, Map<String, Connection>>();
	...
	/** 将所有机器的自检结果 */
	public static Map<String/** IP */
	, Integer> getAllZooKeeperStatusType() {
